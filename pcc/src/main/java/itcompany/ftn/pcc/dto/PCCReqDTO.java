...
public class PCCReqDTO {
	...
	@NotBlank(message = "Acquirer timestamp is not provided.")
	...
	public PCCReqDTO(String acquirerOrderId, Timestamp acquirerTimestamp, Double amount, String pAN,
